...
const colorFilter = Color(0xfff3e5f5);
const colorNew = Color(0xffFFA000);
const colorApproved = Colors.green;
const colorCancel = Colors.grey;
const colorDone = Colors.blue;